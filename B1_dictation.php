...
<?php
 function validateTest($s){
 	...
 	if ((failedTest())||($_SESSION['score'] < 96)){
 		header("Location: http://localhost/proj2/failTest.php?pg=B1_dictation");
 	}else{
 		header("Location: http://localhost/proj2/successTest.php?pg=B1_dictation"); 		
 	}
...
if(isset($_POST['reset'])){
	header("Location: http://localhost/proj2/B1_dictation.php");
}
