...
<!Doctype html>
<body>
 <?php echo "Test de <b>Listening</b> du niveau <b>".$_SESSION['currentLevel']." ( ".getDescriptionLevel($_SESSION['currentLevel'])." ) </b>"; ?>
...
{
	$_SESSION['tests']['listening']= $s;
 	$_SESSION['score'] = array_sum($_SESSION['tests']);
	header("Location: http://localhost/proj2/".$_SESSION['currentLevel']."_dictation.php?sum=".$s."&score=".$score."&pg=".$_SESSION['currentLevel']."_listening.php");		
...
if(isset($_POST['reset'])){
	header("Location: http://localhost/proj2/A1_listening.php");
}
