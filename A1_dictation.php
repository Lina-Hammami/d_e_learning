...
<?php
 function validateTest($s){
 	...
 	if ((failedTest())||($_SESSION['score'] < 96)){
 		header("Location: http://localhost/proj2/failTest.php?pg=A1_dictation");
 	}else{
 		header("Location: http://localhost/proj2/successTest.php?pg=A1_dictation"); 		
 	}
...
if(isset($_POST['reset'])){
	header("Location: http://localhost/proj2/A1_dictation.php");
}
