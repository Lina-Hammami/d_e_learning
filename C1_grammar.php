...
<!Doctype html>
<body>
 <?php echo "Test de <b>Grammaire</b> du niveau <b>".$_SESSION['currentLevel']." ( ".getDescriptionLevel($_SESSION['currentLevel'])." ) </b>"; ?>
...
{
	$_SESSION['tests']['grammar']= $s;
 	$_SESSION['score'] = array_sum($_SESSION['tests']);
	header("Location: http://localhost/proj2/".$_SESSION['currentLevel']."_listening.php?sum=".$s."&score=".$score."&pg=".$_SESSION['currentLevel']."_grammar");		
...
if(isset($_POST['reset'])){
	header("Location: http://localhost/proj2/C1_grammar.php");
}
